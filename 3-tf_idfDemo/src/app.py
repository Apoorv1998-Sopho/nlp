...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        self.uploadButton.resize(50,20)
        self.uploadButton.move(20, a-85)

        # Create TrainedOnFileLabel
        self.TrainedON = QLabel(self)
        self.TrainedON.setText("Trained on :")
        self.TrainedON.resize(wi-600,40)
        self.TrainedON.move(400, a-85)

        # Create a Parent Label
        self.label = QLabel(self)
        self.label.setText("TFIDFtrain")
    ...
    def on_click(self):
        ...
        print('str(tf_idf_vec)', str(tf_idf_vec))
